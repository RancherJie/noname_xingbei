...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			fengZhiJianSheng:['male','ji',6,['fengNuZhuiJi','shengJian','lieFengJi','jiFengJi','jianYing'],],
            kuangZhanShi:['male','xue',6,['kuangHua','xueYingKuangDao','xueXingPaoXiao','siLie'],],
            shenJianShou:['female','ji',6,['shanDianJian','guanChuanSheJi','shanGuangXianJing','jingZhunSheJi','juJi'],],
            fengYinShi:['female','huan',6,['faShuJiDang','diZhiFengYin','shuiZhiFengYin','huoZhiFengYin','fengZhiFengYin','leiZhiFengYin','wuXiShuFu','fengYinPoSui'],],
            anShaZhe:['male','ji',6,['fanShi','shuiYing','qianXing'],],
            shengNv:['female','sheng',6,['bingShuangDaoYan','zhiLiaoShu','zhiYuZhiGuang','lianMin','shengLiao'],],
            tianShi:['female','sheng',6,['fengZhiJieJing','tianShiZhuFu','tianShiJiBan','tianShiZhiQiang','tianShiZhiGe','shenZhiBiHu'],],
            moFaShaoNv:['female','yong',6,['moBaoChongJi','moDanZhangWo','moDanRongHe','huiMieFengBao'],],
            //moJianShi:['female','huan',6,['jianxiong'],],
            //shengQiangQiShi:['female','sheng',6,['jianxiong'],],
            //yuanSuShi:['male','yong',6,['jianxiong'],],
